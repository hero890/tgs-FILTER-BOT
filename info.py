...
URL = "https://tech-hero-filter-bot-1.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://tech-hero-filter-bot-1.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://tech-hero-filter-bot-1.onrender.com/".format(FQDN)
else:
    URL = "https://tech-hero-filter-bot-1.onrender.com/".format(FQDN)
